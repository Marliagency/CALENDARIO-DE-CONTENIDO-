...
Lee un JSON de prompts, los envía uno a uno a la API de ComfyUI vía el
endpoint /prompt, espera a que cada generación termine (escuchando el
WebSocket de ComfyUI), y descarga los videos resultantes a una carpeta local.
...
def wait_for_completion(comfy_url, prompt_id, client_id, timeout=1800):
    ...
    Devuelve cuando el prompt_id ya no está ejecutándose.
    """
